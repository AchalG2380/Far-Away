...
if not exist "%VPYTHON%" (
    ...
    echo [SETUP] 1/5 Core...
    "%VPYTHON%" -m pip install --timeout 300 "numpy==1.26.4" "protobuf==4.25.9" "ml_dtypes==0.5.4" "websockets==12.0" "python-dotenv==1.0.1" "python-multipart==0.0.9" "fastapi==0.110.0" "uvicorn[standard]==0.27.1" "groq==0.11.0" "httpx==0.27.2" "deep-translator==1.11.4" "gtts==2.5.1" "scikit-learn==1.4.0" "pandas==2.2.0" "scipy==1.13.1"
